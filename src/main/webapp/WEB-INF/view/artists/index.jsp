								...
								<div class="media">
									<div class="media-content">
										<p class="title is-4">
											...
											<a href="${showUrl}">${artist.name}</a>
										</p>
										<p class="subtitle is-6">${artist.location}</p>
									</div>
								</div>
							</div>
							<div class="card-content">
								<time>Member since: <fmt:formatDate value="${artist.created_at}" type="date" pattern="d/M/yyyy"/></time>
							</div>
						</div>
					</div>
				</c:forEach>
